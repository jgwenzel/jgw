<?php
namespace DoneLogic\Gate\Helper;
/**
 * DoneLogic/Gate/Helper/Data.php
...
class Data extends AbstractHelper
{
    ...
    const MODULE_ENABLE_DISABLE = 'gate/general/enable'; // SectionName/GroupName/FieldNAme from system.xml

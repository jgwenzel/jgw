...
/**
 * DoneLogic/Gtag/Block/GtagBody.php
 * @author John Wenzel johngwenzel@gmail.com
 * If module has been "enabled" in admin config menu, the gtag_body_snippet
 * is fetched from donelogic_core table via get() which is called
 * from gtag_body.phtml template.
 */
use Magento\Framework\View\Element\Template;
use DoneLogic\Gtag\Helper\Data;

class GtagBody extends Template
{
    private $recordModel;
    private $is_enabled;
    ...
    public function get()
    {
        ...
        elseif(!$this->recordModel->load( 'gtag_body_snippet', 'name')) {
            $value = '<!-- gtag_body_snippet value is not set -->';
        } 
        else {

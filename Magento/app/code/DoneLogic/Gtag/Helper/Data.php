<?php
namespace DoneLogic\Gtag\Helper;
/**
 * DoneLogic/Gtag/Helper/Data.php
...
{
    const MODULE_ENABLE_DISABLE = 'gtag/general/enable'; // SectionName/GroupName/FieldNAme from system.xml
